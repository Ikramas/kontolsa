...
<head>
    ...
    <title>Profil - Kadin Indonesia</title>
    ...
    <div class="overflow-x-hidden">
        <div class="zMain-wrap">
            <div class="zSidebar">
                ...
                <div class="zSidebar-fixed">
                    <ul class="zSidebar-menu" id="sidebarMenu">
                        <li>
                            <a href="<?php echo e(url('/companies')); ?>" class="d-flex align-items-center cg-10 ">
                                <div class="d-flex">
                        ...
                        <li class="active"> 
                            <a href="<?php echo e(url('/profile')); ?>" class="d-flex align-items-center cg-10 active">
                                <div class="d-flex">
            ...
            <div class="zMainContent">
                            ...
                            <ul class="dropdown-menu dropdownItem-one">
                                <li>
                                    <a class="d-flex align-items-center cg-8" href="<?php echo e(url('/local/en')); ?>">
                                        <div class="d-flex">
                                            <img src="<?php echo e(asset('assets/uploads/Language/9331729663979.svg')); ?>" alt="" class="w-28 max-w-26" />
                                        </div>
                ...
                <div class="p-30">
                    <h4 class="fs-24 fw-500 lh-34 text-black pb-16">Profil</h4>
                    <div class="bg-white bd-half bd-c-ebedf0 bd-ra-25 p-30">
                        <ul class="zList-one">
                            <li>
                                <p>Nama</p>
                                <p><?php echo e($user->name ?? 'Tidak ada data'); ?></p>
                            </li>
                            <li>
                                <p>Email</p>
                                <p><a href="mailto:<?php echo e($user->email ?? ''); ?>" class="text-707070"><?php echo e($user->email ?? 'Tidak ada data'); ?></a></p>
                            </li>
                            
                            <li>
                                <p>Phone</p>
                                <p><?php echo e($user->mobile ?? 'Tidak ada data'); ?></p>
                            </li>
                            ...
                            <?php if($user->company): ?>
                                <li>
                                    ...
                                    <p><?php echo e($user->company->pic_nik ?? 'Tidak ada data'); ?></p>
                                </li>
                                <li>
                                    <p>Nomor Pokok Wajib Pajak (NPWP)</p>
                                    <p><?php echo e($user->company->pic_npwp ?? 'Tidak ada data'); ?></p>
                                </li>
                                <li>
                                    <p>Jabatan</p>
                                    <p><?php echo e($user->company->pic_position ?? 'Tidak ada data'); ?></p>
                                </li>
                                <li>
                                    <p>Alamat</p>
                                    <p><?php echo e($user->company->pic_address ?? 'Tidak ada data'); ?></p>
                                </li>

                                
                                <?php if($user->company->membership_status == 'Aktif'): ?>
                                    <li>
                                        <p>Nomor Registrasi Nasional</p>
                                        <p><?php echo e($user->company->national_registration_number ?? 'Tidak ada data'); ?></p>
                                    </li>
                                    <li>
                                        <p>Nomor Anggota</p>
                                        <p><?php echo e($user->company->member_number ?? 'Tidak ada data'); ?></p>
                                    </li>
                                    
                                    <li>
                                        <p>Tanggal Expired</p>
                                        <p>
                                            <?php if($user->company->membership_expired_date): ?>
                                                <?php echo e(\Carbon\Carbon::parse($user->company->membership_expired_date)->translatedFormat('d F Y')); ?>
                                    ...
                                    <li>
                                        ...
                                        <p>
                                            <?php
                                                $status = $user->company->membership_status ?? 'Belum Mengisi Data';
                                                $class = '';
                                                switch ($status) {
                                                    case 'Aktif':
                                                    ...
                                                    case 'Menunggu Verifikasi':
                                                        $class = 'text-color13 bg-color13-10';
                                                        break;
                                                    case 'Ditolak':
                                                        $class = 'text-colorEight bg-colorEight-10';
                                                        break;
                                                    default:
                                                        $class = 'text-para-color bg-colorTwo';
                                                        break;
                                                }
                                            ?>
                                            <span class="d-inline-block py-6 px-10 bd-ra-6 fs-14 fw-500 lh-16 <?php echo e($class); ?>">
                                                <?php echo e($status); ?>
                                    ...
                                    <li>
                                        <p>Grup Anggota</p>
                                        <p>
                                            <a href="#" class="text-info d-flex align-items-center cg-5">
                                                <i class="fas fa-link"></i> Bergabung di Grup Tertutup
                                            </a>
                                        </p>
                                    </li>
                                <?php endif; ?>
                            <?php else: ?>
                                ...
                                <li>
                                    <p class="text-danger">Data Perusahaan/Penanggung Jawab belum diisi.</p>
                                </li>
                            <?php endif; ?>
                        </ul>
                    </div>
...
<?php /**PATH C:\Users\Frans HP\Projects\kadin-login-app\resources\views/profile.blade.php ENDPATH**/ ?>