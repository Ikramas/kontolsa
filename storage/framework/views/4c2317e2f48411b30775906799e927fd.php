...
<head>
    ...
    <title>Perusahaan - Kadin Indonesia</title>
    ...
    <div class="overflow-x-hidden">
        ...
        <div class="zMain-wrap">
            <div class="zSidebar">
                ...
                <a href="<?php echo e(url('/')); ?>" class="d-block mx-26 mb-27 max-w-220 pt-23">
                    <img class="max-h-35" src="<?php echo e(asset('assets/uploads/Setting/6281729670913.png')); ?>" alt="Kadin Indonesia" />
                </a>
                <div class="zSidebar-fixed">
                    <ul class="zSidebar-menu" id="sidebarMenu">
                        <li class="active">
                            <a href="<?php echo e(url('/companies')); ?>" class="d-flex align-items-center cg-10 active">
                                <div class="d-flex">
                        ...
                        <li>
                            <a href="<?php echo e(url('/members')); ?>" class="d-flex align-items-center cg-10 ">
                                <div class="d-flex">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M20.4906 9.39822C20.4906 14.0906 16.6867 17.8945 11.9943 17.8945C7.30197 17.8945 3.49805 14.0906 3.49805 9.39822C3.49805 4.70585 7.30197 0.901924 11.9943 0.901924C16.6867 0.901924 20.4906 4.70585 20.4906 9.39822Z" stroke="white" stroke-opacity="0.7" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                        <path d="M4.63477 13.5656L0.856444 20.1099L4.93902 19.016L6.03294 23.0985L9.3112 17.4204" stroke="white" stroke-opacity="0.7" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                        ...
                        <li>
                            <a href="<?php echo e(url('/transactions')); ?>" class="d-flex align-items-center cg-10">
                                <div class="d-flex">
                        ...
                        <li>
                            <a href="<?php echo e(url('/profile')); ?>" class="d-flex align-items-center cg-10">
                                <div class="d-flex">
                        ...
                        <li>
                            <a href="<?php echo e(url('/settings')); ?>" class="d-flex align-items-center cg-10">
                                <div class="d-flex">
                        ...
                        <li>
                            <a href="<?php echo e(url('/guide')); ?>" class="d-flex align-items-center cg-10">
                                <div class="d-flex">
                                    <svg width="20" height="22" viewBox="0 0 20 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <ul>
                        <a href="<?php echo e(route('logout')); ?>" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="d-inline-flex align-items-center cg-15 pt-17 pb-30 px-25">
                            <img src="<?php echo e(asset('assets/images/icon/logout.svg')); ?>" alt="" />
            ...
            <div class="zMainContent">
                    ...
                    <div class="right d-flex justify-content-end align-items-center cg-15">
                        <div class="dropdown headerUserDropdown lanDropdown">
                            <button class="dropdown-toggle p-0 border-0 bg-transparent d-flex align-items-center cg-8" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                <div class="flex-shrink-0 w-42 h-42 rounded-circle overflow-hidden bd-one bd-c-black-5 bg-fafafa d-flex justify-content-center align-items-center">
                                    <img class="h-100 object-fit-cover w-100" src="<?php echo e(asset('assets/uploads/Language/9931729663970.svg')); ?>" alt="" />
                                </div>
                            ...
                            <ul class="dropdown-menu dropdownItem-one">
                                <li>
                                    <a class="d-flex align-items-center cg-8" href="<?php echo e(url('/local/en')); ?>">
                                        <div class="d-flex">
                                            <img src="<?php echo e(asset('assets/uploads/Language/933172729663979.svg')); ?>" alt="" class="w-28 max-w-26" />
                                        </div>
                                        <p class="fs-14 fw-500 lh-16 text-707070">English</p>
                                    </a>
                                </li>
                                <li>
                                    <a class="d-flex align-items-center cg-8" href="<?php echo e(url('/local/id')); ?>">
                                        <div class="d-flex">
                                            <img src="<?php echo e(asset('assets/uploads/Language/9931729663970.svg')); ?>" alt="" class="w-28 max-w-26" />
                                        </div>
                        ...
                        <div class="d-flex align-items-center cg-17">
                            ...
                            <div class="dropdown headerUserDropdown">
                                <button class="dropdown-toggle p-0 border-0 bg-transparent d-flex align-items-center cg-8" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                    <div class="text-start d-none d-sm-block">
                                        ...
                                        <h4 class="fs-15 fw-500 lh-18 text-1b1c17"><?php echo e($user->name ?? 'Pengguna'); ?></h4>
                                    </div>
                                </button>
                                <ul class="dropdown-menu dropdownItem-one">
                                    <li>
                                        <a class="d-flex align-items-center cg-8" href="<?php echo e(url('/profile')); ?>">
                                            <div class="d-flex">
                                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <li>
                                        <a class="d-flex align-items-center cg-8" href="<?php echo e(route('logout')); ?>" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                                            <div class="d-flex">
                            ...
                            <button class="d-md-none bd-one bd-c-ededed bd-ra-12 w-30 h-30 d-flex justify-content-center align-items-center text-707070 p-0 bg-transparent" type="button" data-bs-toggle="offcanvas" data-bs-target="#homeRightSideView" aria-controls="homeRightSideView">
                                <img src="<?php echo e(asset('assets/images/icon/nav-right-menu.svg')); ?>" alt="" />
                            </button>
                        </div>
                    </div>
                </div>
                <div class="p-30">
                    <div class="d-flex flex-wrap justify-content-between align-items-center pb-16">
                        <h4 class="fs-24 fw-500 lh-34 text-black">Data Perusahaan</h4>
                    </div>

                    <div class="row">
                        <div class="col-md-8 order-2 order-md-1 mb-20">
                            <div class="bg-white bd-half bd-c-ebedf0 bd-ra-25 p-30">
                                <div class="section-pic">
                                    ...
                                    <div class="primary-form-group mb-3">
                                        <div class="primary-form-group-wrap">
                                            <label for="pic_name" class="form-label">Nama</label>
                                            <input type="text" name="pic_name" id="pic_name" class="primary-form-control" value="<?php echo e($user->name ?? 'Tidak ada data'); ?>" placeholder="Nama" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="ms-2 mb-3">
                                                <small class="d-block text-muted">Kartu Tanda Penduduk (KTP)</small>
                                                <div class="d-inline-block">
                                                    <a href="<?php echo e(asset('storage/uploads/companies/' . ($company->pic_ktp_file ?? ''))); ?>" target="_blank">Lihat</a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="primary-form-group mb-3">
                                                <div class="primary-form-group-wrap">
                                                    <label for="pic_nik" class="form-label">Nomor Induk Kependudukan (NIK)</label>
                                                    <input type="text" name="pic_nik" id="pic_nik" class="primary-form-control nik" value="<?php echo e($company->pic_nik ?? 'Tidak ada data'); ?>" placeholder="Nomor Induk Kependudukan (NIK)" readonly>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="ms-2 mb-3">
                                                <small class="d-block text-muted">Nomor Pokok Wajib Pajak (NPWP)</small>
                                                <div class="d-inline-block">
                                                    <a href="<?php echo e(asset('storage/uploads/companies/' . ($company->pic_npwp_file ?? ''))); ?>" target="_blank">Lihat</a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="primary-form-group mb-3">
                                                <div class="primary-form-group-wrap">
                                                    <label for="pic_npwp" class="form-label">Nomor Pokok Wajib Pajak (NPWP)</label>
                                                    <input type="text" name="pic_npwp" id="pic_npwp" class="primary-form-control npwp" value="<?php echo e($company->pic_npwp ?? 'Tidak ada data'); ?>" placeholder="Nomor Pokok Wajib Pajak (NPWP)" readonly>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="ms-2 mb-3">
                                        <small class="d-block text-muted">Pas Foto</small>
                                        <div class="d-inline-block">
                                            <a href="<?php echo e(asset('storage/uploads/companies/' . ($company->pic_photo_file ?? ''))); ?>" target="_blank">Lihat</a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="primary-form-group mb-3">
                                        <div class="primary-form-group-wrap">
                                            ...
                                            <input type="text" name="pic_position" id="pic_position" class="primary-form-control" value="<?php echo e($company->pic_position ?? 'Tidak ada data'); ?>" placeholder="Jabatan" readonly>
                                        </div>
                                    </div>

                                    <div class="primary-form-group mb-3">
                                        <div class="primary-form-group-wrap">
                                            <label for="pic_address" class="form-label">Alamat</label>
                                            <input type="text" name="pic_address" id="pic_address" class="primary-form-control" value="<?php echo e($company->pic_address ?? 'Tidak ada data'); ?>" placeholder="Alamat" readonly>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="primary-form-group mb-3">
                                    <div class="primary-form-group-wrap">
                                        <label for="ab-name" class="form-label">Nama Perusahaan</label>
                                        <input type="text" name="name" id="ab-name" class="primary-form-control" value="<?php echo e($company->company_name ?? 'Tidak ada data'); ?>" placeholder="Nama Perusahaan" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="ms-2 mb-3">
                                            <small class="d-block text-muted">Nomor Induk Berusaha (NIB)</small>
                                            <div class="d-inline-block">
                                                <a href="<?php echo e(asset('storage/uploads/companies/' . ($company->company_nib_file ?? ''))); ?>" target="_blank">Lihat</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="primary-form-group mb-3">
                                            <div class="primary-form-group-wrap">
                                                <label for="ab-nib" class="form-label">Nomor Induk Berusaha (NIB)</label>
                                                <input type="text" name="nib" id="ab-nib" class="primary-form-control nib" value="<?php echo e($company->company_nib ?? 'Tidak ada data'); ?>" placeholder="Nomor Induk Berusaha (NIB)" readonly>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="ms-2 mb-3">
                                    <small class="d-block text-muted">SK Kemenkumham</small>
                                    <div class="d-inline-block">
                                        <a href="<?php echo e(asset('storage/uploads/companies/' . ($company->company_sk_kemenkumham_file ?? ''))); ?>" target="_blank">Lihat</a>
                                    </div>
                                </div>

                                <div class="primary-form-group mb-3">
                                    <div class="primary-form-group-wrap">
                                        <label for="ab-sbu" class="form-label">Nomor Sertifikat Badan Usaha</label>
                                        <input type="text" name="sbu" id="ab-sbu" class="primary-form-control sbu" value="<?php echo e($company->company_sbu ?? 'Tidak ada data'); ?>" placeholder="Nomor Sertifikat Badan Usaha" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="ms-2 mb-3">
                                            <small class="d-block text-muted">NPWP Badan Usaha</small>
                                            <div class="d-inline-block">
                                                <a href="<?php echo e(asset('storage/uploads/companies/' . ($company->company_npwp_file ?? ''))); ?>" target="_blank">Lihat</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="primary-form-group mb-3">
                                            <div class="primary-form-group-wrap">
                                                <label for="ab-npwp" class="form-label">NPWP Badan Usaha</label>
                                                <input type="text" name="npwp" id="ab-npwp" class="primary-form-control npwp" value="<?php echo e($company->company_npwp ?? 'Tidak ada data'); ?>" placeholder="NPWP Badan Usaha" readonly>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="primary-form-group mb-3">
                                    <div class="primary-form-group-wrap">
                                        <label for="ab-address" class="form-label">Alamat Perusahaan</label>
                                        <input type="text" name="address" id="ab-address" class="primary-form-control" value="<?php echo e($company->company_address ?? 'Tidak ada data'); ?>" placeholder="Alamat Perusahaan" readonly>
                                    </div>
                                </div>

                                <div class="primary-form-group mb-3">
                                    <div class="primary-form-group-wrap">
                                        <label for="ab-province" class="form-label">Provinsi</label>
                                        <input type="text" class="primary-form-control" value="<?php echo e($company->company_province ?? 'Tidak ada data'); ?>" readonly>
                                    </div>
                                </div>
                                <div class="primary-form-group mb-3">
                                    <div class="primary-form-group-wrap">
                                        <label for="ab-city" class="form-label">Kabupaten/Kota</label>
                                        <input type="text" class="primary-form-control" value="<?php echo e($company->company_city ?? 'Tidak ada data'); ?>" readonly>
                                    </div>
                                </div>
                                <div class="primary-form-group mb-3">
                                    <div class="primary-form-group-wrap">
                                        <label for="ab-postal_code" class="form-label">Kode Pos</label>
                                        <input type="text" name="postal_code" id="ab-postal_code" class="primary-form-control postal_code" value="<?php echo e($company->company_postal_code ?? 'Tidak ada data'); ?>" placeholder="Kode Pos" readonly>
                                    </div>
                                </div>

                                <div class="primary-form-group mb-3">
                                    <div class="primary-form-group-wrap">
                                        <label for="ab-kbli" class="form-label">Kode KBLI</label>
                                        <input type="text" name="kbli" id="ab-kbli" class="primary-form-control kbli" value="<?php echo e($company->company_kbli ?? 'Tidak ada data'); ?>" placeholder="Kode KBLI" readonly>
                                    </div>
                                </div>
                                <div class="primary-form-group mb-3">
                                    <div class="primary-form-group-wrap">
                                        <label for="ab-business_category" class="form-label">Kategori Usaha</label>
                                        <input type="text" class="primary-form-control" value="<?php echo e($company->company_business_category ?? 'Tidak ada data'); ?>" readonly>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 order-1 order-md-2 mb-20">
                            <div class="bg-white bd-half bd-c-ebedf0 bd-ra-25 p-30">
                                <div class="mb-3">
                                    <label class="fw-bold">Tipe Keanggotaan</label>
                                    <div><?php echo e($company->membership_type ?? 'Tidak ada data'); ?></div>
                                </div>
                                <div class="mb-3">
                                    <label class="fw-bold">Klasifikasi</label>
                                    <div><?php echo e($company->membership_classification ?? 'Tidak ada data'); ?></div>
                                </div>
                                
                                <div class="mb-3">
                                    <label class="fw-bold">Tanggal Expired</label>
                                    <div>
                                        <?php if($company->membership_expired_date && $company->membership_status == 'Aktif'): ?>
                                            <?php echo e(\Carbon\Carbon::parse($company->membership_expired_date)->translatedFormat('d F Y')); ?>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div>
                                        <?php
                                            ...
                                            $statusText = 'Tidak ada data'; // Default jika $company->membership_status null
                                            $statusClass = 'text-secondary bg-ededed'; // Default class
                                            
                                            if ($status) { // Hanya proses jika $status tidak null
                                                switch($status) {
                                                    case 'Verifikasi Perusahaan':
                                                        $statusText = 'Verifikasi Perusahaan';
                                                        $statusClass = 'text-f5b40a bg-f5b40a-10'; // Oranye
                                                        break;
                                                    case 'Aktif':
                                                        $statusText = 'Aktif';
                                                        $statusClass = 'text-0fa958 bg-0fa958-10'; // Hijau
                                                        break;
                                                    default:
                                                        $statusText = $status; // Tampilkan status apa adanya jika tidak cocok
                                                        $statusClass = 'text-secondary bg-ededed'; // Default untuk status lain
                                                        break;
                                                }
                                            }
                                        ?>

                                        <span class="d-inline-block py-6 px-10 bd-ra-6 fs-14 fw-500 lh-16 <?php echo e($statusClass); ?>">
                                ...
                                <?php if($company->membership_status == 'Aktif'): ?>
                                <div class="mb-3">
                                    <label class="fw-bold">Aksi</label>
                                    <div class="dropdown">
                                        <button class="btn btn-primary btn-sm dropdown-toggle" type="button" data-bs-toggle="dropdown">Aksi</button>
                                        <ul class="dropdown-menu">
                                            <li><a class="dropdown-item" href="<?php echo e(route('companies.index')); ?>">Edit Data</a></li>
                                        </ul>
                                    </div>
                                </div>
                                <?php endif; ?>
...
</html><?php /**PATH C:\Users\Frans HP\Projects\kadin-login-app\resources\views/companies.blade.php ENDPATH**/ ?>