...
<head>
    ...
    <title>Setting - Kadin Indonesia</title>
    ...
    <div class="overflow-x-hidden">
        ...
        <div class="zMain-wrap">
            <div class="zSidebar">
                ...
                <div class="zSidebar-fixed">
                    <ul class="zSidebar-menu" id="sidebarMenu">
                        ...
                        <li class="active"> {{-- Tambahkan class 'active' untuk menandai halaman aktif --}}
                            <a href="{{ url('/settings') }}" class="active d-flex align-items-center cg-10">
                                <div class="d-flex">
            ...
            <div class="zMainContent">
                ...
                <div class="p-30">
                    <div class="">
                        <h4 class="fs-24 fw-500 lh-34 text-black pb-16">Pengaturan</h4>
                        <div class="bg-white bd-half bd-c-ebedf0 bd-ra-25 p-30">
                            <ul class="nav nav-tabs zTabHead" id="myTab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active" id="security-tab" data-bs-toggle="tab" data-bs-target="#security-tab-pane" type="button" role="tab" aria-controls="security-tab-pane" aria-selected="true">Keamanan</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="changePassword-tab" data-bs-toggle="tab" data-bs-target="#changePassword-tab-pane" type="button" role="tab" aria-controls="changePassword-tab-pane" aria-selected="false">Ubah Kata Sandi</button>
                                </li>
                            </ul>
                                    ...
                                    <div class="max-w-840">
                                        <ul class="securityList">
                                            <li class="d-flex justify-content-between align-items-center">
                                                <div class="">
                                                    <h4 class="fs-18 fw-500 lh-28 text-1b1c17">Nomor Handphone</h4>
                                                    <p class="fs-14 fw-400 lh-22 text-707070">
                                                        {{-- Ganti dengan nomor handphone user dari database --}}
                                                        {{ $user->mobile ?? 'Tidak ada nomor' }}
                                                    </p>
                                                </div>
                                            </li>
                                            <li class="d-flex justify-content-between align-items-center">
                                                <div class="">
                                                    <h4 class="fs-18 fw-500 lh-28 text-1b1c17">Alamat Email</h4>
                                                    <p class="fs-14 fw-400 lh-22 text-707070">
                                                        {{-- Menampilkan email user yang login --}}
                                                        <a href="mailto:{{ $user->email ?? 'Tidak ada email' }}" class="text-707070">{{ $user->email ?? 'Tidak ada email' }}</a>
                                                    </p>
                                                </div>
                                                <button type="button" class="zBtn-one active">Verified</button>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="tab-pane fade" id="changePassword-tab-pane" role="tabpanel" aria-labelledby="changePassword-tab" tabindex="0">
                                    <div class="max-w-840">
                                        <div class="pb-35">
                                            <h4 class="fs-18 fw-600 lh-24 text-1b1c17 pb-4">Ubah Kata Sandi</h4>
                                            <p class="fs-14 fw-400 lh-24 text-707070">Ubah atau setel ulang kata sandi akun Anda</p>
                                        </div>
                                        {{-- Form untuk Ubah Kata Sandi --}}
                                        <form class="ajax reset" action="{{ route('password.update') }}" data-handler="commonResponseRedirect" data-redirect-url="{{ url('/settings') }}" method="POST">
                                            @csrf {{-- CSRF Token Laravel --}}
                                            @method('PUT') {{-- Metode PUT untuk update password --}}

                                            {{-- Menampilkan pesan error validasi (dari ProfileController) --}}
                                            ...
                                            @endif
                                            {{-- Menampilkan pesan sukses (dari ProfileController) --}}
                                            ...
                                            <div class="primary-form-group mb-3">
                                                <div class="primary-form-group-wrap">
                                                    ...
                                                    <input type="password" name="current_password" class="primary-form-control" id="current_password" placeholder="Masukkan Kata Sandi Saat Ini" />
                                            ...
                                            <div class="primary-form-group mb-3">
                                                <div class="primary-form-group-wrap">
                                                    ...
                                                    <input type="password" name="password" class="primary-form-control" id="password" placeholder="Masukkan Kata Sandi Baru" />
                                                    <button type="button" class="btn togglePassword">
                                                        <i class="fas fa-eye-slash"></i>
                                                    </button>
                                                </div>
                                            ...
                                            <div class="primary-form-group mb-3">
                                                <div class="primary-form-group-wrap">
                                                    ...
                                                    <input type="password" name="password_confirmation" class="primary-form-control" id="password_confirmation" placeholder="Konfirmasi Password" />
                                                    <button type="button" class="btn togglePassword">
                                                        <i class="fas fa-eye-slash"></i>
                                                    </button>
                                                </div>
                                            ...
                                            <button type="submit" class="btn btn-primary mt-30 py-10 px-26 border-0 bd-ra-12 fs-15 fw-500 lh-25">Simpan Sekarang</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
