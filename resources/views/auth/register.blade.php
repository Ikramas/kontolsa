...
<head>
    ...
    {{-- reCAPTCHA script removed for now --}}
</head>
                ...
                <div class="primary-form">
                    ...
                    <div id="section-form-register">
                        ...
                        <form action="{{ route('register') }}" method="post" id="form">
                            ...
                            <div class="primary-form-group mb-3">
                                <div class="primary-form-group-wrap">
                                    ...
                                    <select name="membership_type" id="membership_type" class="primary-form-control" required>
                                        ...
                                        {{-- Perubahan di sini: value tetap singkatan untuk backend, tapi teks tampilan adalah nama lengkap --}}
                            ...
                            {{-- reCAPTCHA v3 Hidden Input removed for now --}}
        ...
        $(document).ready(function() {
            ...
            $('.btnSubmit').on('click', function(e) {
                ...
                form.find(':input[required]:enabled').each(function() {
                    ...
                    } else { // Generic check for other required text, email, select, etc.
                        if (!input.val()) {
                            input.addClass('is-invalid');
                ...
                // NO reCAPTCHA CHECK HERE as it's ignored for now
                ...
                $.ajax({
                    ...
                    data: formData,
                    contentType: false, // Essential for sending FormData
                        ...
                        if (response.success) {
                            ...
                            if (errors) {
                                $.each(errors, function(key, value) {
                                    ...
                                    // Special handling for password confirmation if key is 'password_confirmation'
                                    if (inputElement.length === 0 && key === 'password_confirmation') {
