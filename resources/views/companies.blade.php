                            ...
                            <ul class="dropdown-menu dropdownItem-one">
                                <li>
                                    <a class="d-flex align-items-center cg-8" href="{{ url('/local/en') }}">
                                        <div class="d-flex">
                                            <img src="{{ asset('assets/uploads/Language/933172729663979.svg') }}" alt="" class="w-28 max-w-26" />
                                        </div>
                            ...
                            <div class="bg-white bd-half bd-c-ebedf0 bd-ra-25 p-30">
                                <div class="section-pic">
                                    ...
                                    <div class="primary-form-group mb-3">
                                        <div class="primary-form-group-wrap">
                                            ...
                                            <input type="text" name="pic_name" id="pic_name" class="primary-form-control" value="{{ $user->name ?? 'Tidak ada data' }}" placeholder="Nama" readonly>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="ms-2 mb-3">
                                                ...
                                                <div class="d-inline-block">
                                                    <a href="{{ asset('storage/uploads/companies/' . ($company->pic_ktp_file ?? '')) }}" target="_blank">Lihat</a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="primary-form-group mb-3">
                                                <div class="primary-form-group-wrap">
                                                    ...
                                                    <input type="text" name="pic_nik" id="pic_nik" class="primary-form-control nik" value="{{ $company->pic_nik ?? 'Tidak ada data' }}" placeholder="Nomor Induk Kependudukan (NIK)" readonly>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="ms-2 mb-3">
                                                ...
                                                <div class="d-inline-block">
                                                    <a href="{{ asset('storage/uploads/companies/' . ($company->pic_npwp_file ?? '')) }}" target="_blank">Lihat</a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="primary-form-group mb-3">
                                                <div class="primary-form-group-wrap">
                                                    ...
                                                    <input type="text" name="pic_npwp" id="pic_npwp" class="primary-form-control npwp" value="{{ $company->pic_npwp ?? 'Tidak ada data' }}" placeholder="Nomor Pokok Wajib Pajak (NPWP)" readonly>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="ms-2 mb-3">
                                        ...
                                        <div class="d-inline-block">
                                            <a href="{{ asset('storage/uploads/companies/' . ($company->pic_photo_file ?? '')) }}" target="_blank">Lihat</a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="primary-form-group mb-3">
                                        <div class="primary-form-group-wrap">
                                            ...
                                            <input type="text" name="pic_position" id="pic_position" class="primary-form-control" value="{{ $company->pic_position ?? 'Tidak ada data' }}" placeholder="Jabatan" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="primary-form-group mb-3">
                                        <div class="primary-form-group-wrap">
                                            ...
                                            <input type="text" name="pic_address" id="pic_address" class="primary-form-control" value="{{ $company->pic_address ?? 'Tidak ada data' }}" placeholder="Alamat" readonly>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="primary-form-group mb-3">
                                    <div class="primary-form-group-wrap">
                                        ...
                                        <input type="text" name="name" id="ab-name" class="primary-form-control" value="{{ $company->company_name ?? 'Tidak ada data' }}" placeholder="Nama Perusahaan" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="ms-2 mb-3">
                                            ...
                                            <div class="d-inline-block">
                                                <a href="{{ asset('storage/uploads/companies/' . ($company->company_nib_file ?? '')) }}" target="_blank">Lihat</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="primary-form-group mb-3">
                                            <div class="primary-form-group-wrap">
                                                ...
                                                <input type="text" name="nib" id="ab-nib" class="primary-form-control nib" value="{{ $company->company_nib ?? 'Tidak ada data' }}" placeholder="Nomor Induk Berusaha (NIB)" readonly>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="ms-2 mb-3">
                                    ...
                                    <div class="d-inline-block">
                                        <a href="{{ asset('storage/uploads/companies/' . ($company->company_sk_kemenkumham_file ?? '')) }}" target="_blank">Lihat</a>
                                    </div>
                                </div>
                                ...
                                <div class="primary-form-group mb-3">
                                    <div class="primary-form-group-wrap">
                                        ...
                                        <input type="text" name="sbu" id="ab-sbu" class="primary-form-control sbu" value="{{ $company->company_sbu ?? 'Tidak ada data' }}" placeholder="Nomor Sertifikat Badan Usaha" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="ms-2 mb-3">
                                            ...
                                            <div class="d-inline-block">
                                                <a href="{{ asset('storage/uploads/companies/' . ($company->company_npwp_file ?? '')) }}" target="_blank">Lihat</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="primary-form-group mb-3">
                                            <div class="primary-form-group-wrap">
                                                ...
                                                <input type="text" name="npwp" id="ab-npwp" class="primary-form-control npwp" value="{{ $company->company_npwp ?? 'Tidak ada data' }}" placeholder="NPWP Badan Usaha" readonly>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="primary-form-group mb-3">
                                    <div class="primary-form-group-wrap">
                                        ...
                                        <input type="text" name="address" id="ab-address" class="primary-form-control" value="{{ $company->company_address ?? 'Tidak ada data' }}" placeholder="Alamat Perusahaan" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="primary-form-group mb-3">
                                    <div class="primary-form-group-wrap">
                                        ...
                                        <input type="text" class="primary-form-control" value="{{ $company->company_province ?? 'Tidak ada data' }}" readonly>
                                    </div>
                                </div>
                                <div class="primary-form-group mb-3">
                                    <div class="primary-form-group-wrap">
                                        <label for="ab-city" class="form-label">Kabupaten/Kota</label>
                                        <input type="text" class="primary-form-control" value="{{ $company->company_city ?? 'Tidak ada data' }}" readonly>
                                    </div>
                                </div>
                                <div class="primary-form-group mb-3">
                                    <div class="primary-form-group-wrap">
                                        <label for="ab-postal_code" class="form-label">Kode Pos</label>
                                        <input type="text" name="postal_code" id="ab-postal_code" class="primary-form-control postal_code" value="{{ $company->company_postal_code ?? 'Tidak ada data' }}" placeholder="Kode Pos" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="primary-form-group mb-3">
                                    <div class="primary-form-group-wrap">
                                        ...
                                        <input type="text" name="kbli" id="ab-kbli" class="primary-form-control kbli" value="{{ $company->company_kbli ?? 'Tidak ada data' }}" placeholder="Kode KBLI" readonly>
                                    </div>
                                </div>
                                <div class="primary-form-group mb-3">
                                    <div class="primary-form-group-wrap">
                                        <label for="ab-business_category" class="form-label">Kategori Usaha</label>
                                        <input type="text" class="primary-form-control" value="{{ $company->company_business_category ?? 'Tidak ada data' }}" readonly>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 order-1 order-md-2 mb-20">
                            <div class="bg-white bd-half bd-c-ebedf0 bd-ra-25 p-30">
                                <div class="mb-3">
                                    ...
                                    <div>{{ $company->membership_type ?? 'Tidak ada data' }}</div>
                                </div>
                                <div class="mb-3">
                                    <label class="fw-bold">Klasifikasi</label>
                                    <div>{{ $company->membership_classification ?? 'Tidak ada data' }}</div>
                                </div>
                                
                                <div class="mb-3">
                                    <label class="fw-bold">Tanggal Expired</label>
                                    <div>
                                        @if ($company->membership_expired_date && $company->membership_status == 'Aktif')
                                            {{ \Carbon\Carbon::parse($company->membership_expired_date)->translatedFormat('d F Y') }}
                                        @else
                                            -
                                        @endif
                                    </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div>
                                        ...
                                        <span class="d-inline-block py-6 px-10 bd-ra-6 fs-14 fw-500 lh-16 {{ $statusClass }}">
                                            {{ $statusText }}
                                        </span>
                                    </div>
                                </div>

                                {{-- Aksi Button (Hanya muncul jika status 'Aktif') --}}
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a class="dropdown-item" href="{{ route('companies.index') }}">Edit Data</a></li>
                                        </ul>
                                    </div>
                                </div>
                                @endif
